...
/**
 * Servlet implementation class FilterF
 */
@WebServlet("/FilterF")
public class FilterF extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String fName=request.getParameter("farmer");
		try {
			AllFarms=farmdb.getAllFarmDetailsFarmer(fName);
